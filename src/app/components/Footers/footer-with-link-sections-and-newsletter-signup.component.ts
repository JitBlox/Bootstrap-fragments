...
/**
* A responsive footer with multiple sections (created with a Bootstrap Grid), a newsletter
* subscription widget and social links. Each section contains a list of navigation links.
...
*/
@Component({
  selector: 'app-footer-with-link-sections-and-newsletter-signup',
  standalone: true,
  templateUrl: './footer-with-link-sections-and-newsletter-signup.component.html',
  imports: [NgbNavModule, RouterLink, CommonModule]
})
export class FooterWithLinkSectionsAndNewsletterSignupComponent {
