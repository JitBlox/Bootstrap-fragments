...
/**
* A basic header with only navigation links.
...
*/
@Component({
  selector: 'app-simple-responsive-header',
  standalone: true,
  templateUrl: './simple-responsive-header.component.html',
  imports: [NgbNavModule, RouterLink, CommonModule]
})
export class SimpleResponsiveHeaderComponent {
